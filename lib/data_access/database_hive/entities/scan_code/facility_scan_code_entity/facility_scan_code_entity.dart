...
part 'facility_scan_code_entity.g.dart';

const String uniqueId = 'UNIQUE';

@HiveType(typeId: HiveConst.facilityScanCodeTid)
class FacilityScanCodeEntity extends ScanCodeEntity {
  @HiveField(101)
  final List<PointEntity> pointList;

  FacilityScanCodeEntity({
    required String id,
